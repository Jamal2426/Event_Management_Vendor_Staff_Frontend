...
export function ProfileStats() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {[
        { label: 'Events', value: '1,587', icon: <Package size={24} />, iconBg: 'bg-primary/10', iconColor: 'text-primary' },
        { label: 'Clients', value: '46', icon: <Briefcase size={24} />, iconBg: 'bg-destructive/10', iconColor: 'text-destructive' },
        { label: 'Tasks Done', value: '890', icon: <Rocket size={24} />, iconBg: 'bg-green-500/10', iconColor: 'text-green-500' },
      ].map((card, i) => (
