...
export default function AddPaymentContent({ isView = false }: AddPaymentContentProps) {
  ...
  const handleSubmit = (e?: React.FormEvent) => {
    ...
    router.push("/dashboard/payment-management");
  };
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mt-4">
          <div>
            <div className="flex items-center gap-3 mb-2">
              <Link href="/dashboard/payment-management" className="w-9 h-9 flex items-center justify-center rounded-xl border border-gray-100 dark:border-gray-800 text-gray-400 hover:text-blue-500 hover:border-blue-100 transition-all shadow-sm bg-white dark:bg-gray-900">
                <ArrowLeft size={18} />
              </Link>
