...
import { useStaffPortalActivityLog as useVendorActivityLog, type StaffPortalActivityLog as VendorActivityLog } from '@/hooks/use-staff-portal';
...
export default function ActivityLogPage() {
  ...
  const activities = useMemo<VendorActivityLog[]>(() => data?.data ?? [], [data?.data]);
  ...
  return (
    ...
    <div className="h-[calc(100vh-86px)] flex flex-col space-y-4 max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-8 overflow-hidden pt-8 pb-3">
            ...
            {isLoading ? (
              ...
              <div className="divide-y divide-border/30">
                {paginated.map((activity) => {
                  ...
                  const { date, time }  = formatDate(activity.createdAt || new Date().toISOString());
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[13px] text-muted-foreground leading-snug mt-1 font-medium">{activity.details?.description ?? '—'}</p>
      ...
      {detailEntry && (() => {
        ...
        const { date, time }  = formatDate(detailEntry.createdAt || new Date().toISOString());
          ...
          >
            ...
            >
              ...
              <div className="space-y-0 divide-y divide-border/40">
                {[
                  { label: 'Description', value: detailEntry.details?.description ?? '—' },
